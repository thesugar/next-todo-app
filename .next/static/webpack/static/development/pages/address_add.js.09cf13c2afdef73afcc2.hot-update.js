...
function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(AddressAdd, [{
    ...
    value: function doAction(e) {
      ...
      var date = new Date(this.state.deadline);
      db.collection('tasks').add({
        title: this.state.title,
        detail: this.state.detail,
        deadline: firebase__WEBPACK_IMPORTED_MODULE_10___default.a.firestore.Timestamp.fromDate(date),
...
//# sourceMappingURL=address_add.js.09cf13c2afdef73afcc2.hot-update.js.map